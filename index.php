...
$f3->route('GET /ajaxEx/user',		// NB POST here: will be reached by form submission
  function($f3) {
...
$f3->route('GET /our_data', function($f3) {
    $f3->set('content','our_data.html');
    $f3->set('html_title','Our Data');
    echo Template::instance()->render('layout.html');
});

$f3->route('GET /contact', function($f3) {
    $f3->set('content','contact.html');
    $f3->set('html_title','contact');
    echo Template::instance()->render('layout.html');
});
